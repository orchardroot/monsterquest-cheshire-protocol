...
(function () {
  ...
  W.defineMap("tatton_park", MQ.U.merge(DT, {
    ...
    npcs: [
      ...
      { id: "npc_tatton_deer_2", x: 43, y: 14, dir: "left", sprite: "deer", behaviour: "wander", radius: 5, script: "mid_tatton_deer" },
      { id: "npc_tatton_deer_3", x: 12, y: 42, dir: "up", sprite: "deer", behaviour: "wander", radius: 4, script: "mid_tatton_deer" },
      { id: "npc_tatton_deer_4", x: 46, y: 27, dir: "left", sprite: "deer", behaviour: "still", script: "mid_tatton_deer" },
