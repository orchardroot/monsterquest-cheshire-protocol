...
(function () {
  ...
  W.defineMap("knutsford", MQ.U.merge(DL, {
    ...
    warps: [
      ...
      { x: 24, y: 0, to: "tatton_park", tx: 26, ty: 45, dir: "up", kind: "edge" },
      { x: 25, y: 0, to: "tatton_park", tx: 27, ty: 45, dir: "up", kind: "edge" },
      { x: 26, y: 0, to: "tatton_park", tx: 28, ty: 45, dir: "up", kind: "edge" },
      { x: 27, y: 0, to: "tatton_park", tx: 28, ty: 45, dir: "up", kind: "edge" },
