...
//
// MQ.Data.species  — 171 dex species + 5 hidden boss forms (ROSTER §1)
...
(function () {
  ...
  // ---- 1b. Chapter 1 belt ----------------------------------------
  SP(11,"nibbit","NIBBIT","normal",[35,45,40,25,30,50],200,44,"fast","scavenger",[L("gnawlord",18)],"canal","common","low","od_normal",
  ...
  SP(12,"gnawlord","GNAWLORD","normal",[70,90,70,45,55,80],90,146,"medium","scavenger",null,"canal","uncommon","mid","od_normal",
  ...
  SP(13,"flitchick","FLITCHICK","normal/flying",[40,40,35,30,30,60],200,46,"fast","scavenger",[L("galewing",18)],"town","common","low","od_flying",
  ...
  SP(14,"galewing","GALEWING","normal/flying",[65,70,60,50,55,95],90,148,"medium","ridge_wind",null,"moor","uncommon","mid","od_flying",
  ...
  SP(15,"flitmoth","FLITMOTH","bug",[35,35,30,45,35,55],200,44,"fast","silk_weave",[L("bollinmoth",14)],"canal","common","low","od_bug",
  ...
  SP(16,"bollinmoth","BOLLINMOTH","bug/flying",[65,60,55,80,65,80],90,148,"medium","silk_weave",null,"canal","uncommon","mid","od_bug",
  ...
  SP(17,"bobbinet","BOBBINET","bug/psychic",[40,35,45,60,50,45],150,52,"medium","silk_weave",[L("jacquarda",30)],"silk","uncommon","low","od_psychic",
  ...
  SP(18,"jacquarda","JACQUARDA","bug/psychic",[105,70,95,115,112,80],45,232,"slow","signal_jammer",null,"silk","rare","high","od_psychic",
  ...
  SP(19,"towpaddle","TOWPADDLE","water",[45,40,40,40,40,45],200,44,"fast","wetlander",[L("mallardier",20)],"canal","common","low","od_water",
  ...
  SP(20,"mallardier","MALLARDIER","water/flying",[75,70,65,65,65,75],90,150,"medium","wetlander",null,"canal","uncommon","mid","od_water",
  ...
  SP(21,"sootling","SOOTLING","fire",[40,45,40,50,40,45],200,46,"fast","firebox",[L("chimnyx",24)],"mill","common","low","od_fire",
  ...
  SP(22,"chimnyx","CHIMNYX","fire/ghost",[65,70,60,80,70,70],90,152,"medium","nightshift",null,"mill","uncommon","mid","od_fire",
  ...
  SP(23,"nancylith","NANCYLITH","rock",[75,70,110,55,75,35],60,168,"slow","stonemason",null,"moor","rare","mid","od_rock",
  ...
  SP(24,"mistlop","MISTLOP","normal",[50,45,40,30,35,60],200,46,"fast","proxy_fog",[L("harrowlop",22)],"moor","common","low","od_normal",
  ...
  SP(25,"harrowlop","HARROWLOP","normal/ground",[80,85,75,45,55,85],90,154,"medium","iron_will",null,"moor","uncommon","mid","od_ground",
  ...
  SP(26,"pitpony","PITPONY","ground",[55,55,50,30,40,40],190,48,"fast","iron_will",[L("coalcob",26)],"mill","common","low","od_ground",
  ...
  SP(27,"coalcob","COALCOB","ground/fire",[85,90,75,60,60,55],90,156,"medium","firebox",null,"mill","uncommon","mid","od_ground",
  ...
  SP(28,"sparkit","SPARKIT","electric",[40,40,35,55,40,60],190,48,"fast","static_charge",[L("fulgurcat",22)],"town","common","low","od_electric",
  ...
  SP(29,"fulgurcat","FULGURCAT","electric",[60,65,50,85,60,95],90,158,"medium","static_charge",null,"town","uncommon","mid","od_electric",
  ...
  SP(30,"puddlish","PUDDLISH","water",[40,40,40,45,40,45],200,44,"fast","wetlander",[L("torrentide",20)],"mere","common","low","od_water",
  ...
  SP(31,"torrentide","TORRENTIDE","water",[70,80,65,65,65,80],90,150,"medium","wetlander",null,"river","uncommon","mid","od_water",
  ...
  SP(32,"peepcam","PEEPCAM","cyber",[40,35,55,60,50,45],150,54,"medium","signal_jammer",[L("panoptix",30)],"town","uncommon","low","od_cyber",
  ...
  SP(33,"panoptix","PANOPTIX","cyber/psychic",[100,65,101,115,112,85],45,236,"slow","honeypot",null,"urban","rare","high","od_cyber",
  ...
  SP(34,"grousel","GROUSEL","flying/ground",[50,50,45,35,40,55],190,48,"fast","ridge_wind",[L("moorcock",26)],"moor","common","low","od_flying",
  ...
  SP(35,"moorcock","MOORCOCK","flying/ground",[80,85,70,50,60,80],90,156,"medium","ridge_wind",null,"moor","uncommon","mid","od_flying",
  ...
  SP(36,"mistewe","MISTEWE","normal",[85,60,85,50,80,45],180,96,"medium","thick_fleece",null,"moor","common","mid","od_normal",
  ...
  SP(37,"piphart","PIPHART","normal",[50,45,40,40,45,60],190,50,"fast","thick_fleece",[L("stagwire",24)],"estate","common","low","od_electric",
  ...
  SP(38,"stagwire","STAGWIRE","normal/electric",[75,80,65,70,65,80],90,158,"medium","static_charge",null,"estate","uncommon","mid","od_electric",
  ...
  // ---- 1c. Chapter 2 belt ----------------------------------------
  SP(39,"sheepwire","SHEEPWIRE","electric",[55,45,55,60,55,40],190,54,"fast","thick_fleece",[L("ramvolt",24)],"estate","common","low","od_electric",
  ...
  SP(40,"ramvolt","RAMVOLT","electric",[75,85,75,70,65,55],90,160,"medium","thick_fleece",null,"estate","uncommon","mid","od_electric",
  ...
  SP(41,"heronet","HERONET","water/flying",[45,50,40,50,45,55],180,56,"fast","rain_caller",[L("herowing",22)],"river","common","low","od_water",
  ...
  SP(42,"herowing","HEROWING","water/flying",[70,75,60,70,65,80],90,162,"medium","rain_caller",null,"river","uncommon","mid","od_water",
  ...
  SP(43,"sluiceling","SLUICELING","water",[50,45,55,50,50,40],180,56,"fast","damp_squib",[L("millrace",25)],"mill","common","low","od_water",
  ...
  SP(44,"millrace","MILLRACE","water/rock",[80,85,100,60,70,45],90,166,"medium","damp_squib",null,"mill","uncommon","mid","od_water",
  ...
  SP(45,"puppetacct","PUPPETACCT","cyber",[45,50,40,55,40,60],150,58,"fast","proxy_fog",null,"fog","common","low","od_cyber",
  ...
  SP(46,"botling","BOTLING","cyber/bug",[45,55,50,45,45,50],150,58,"fast","payload",[L("botnetle",22)],"cyber","uncommon","low","od_cyber",
  ...
  SP(47,"botnetle","BOTNETLE","cyber/bug",[105,100,112,75,95,70],60,224,"slow","payload",null,"cyber","uncommon","high","od_cyber",
  ...
  SP(48,"mistwisp","MISTWISP","ghost/poison",[40,40,40,60,50,60],180,58,"fast","nightshift",[L("phantasmal",30)],"bog","common","low","od_ghost",
  ...
  SP(49,"phantasmal","PHANTASMAL","ghost/poison",[65,60,60,90,75,70],90,168,"medium","nightshift",null,"bog","uncommon","mid","od_ghost",
  ...
  SP(50,"bogleap","BOGLEAP","water/poison",[55,50,50,45,45,45],180,58,"fast","damp_squib",[L("toadlore",26)],"bog","common","low","od_water",
  ...
  SP(51,"toadlore","TOADLORE","water/poison",[132,80,101,85,107,45],60,226,"slow","sandbox",null,"bog","uncommon","high","od_water",
  ...
  SP(52,"peatkin","PEATKIN","ground/ghost",[50,55,55,45,45,40],150,60,"medium","cold_storage",[L("lindowan",28)],"bog","uncommon","low","od_ghost",
  ...
  SP(53,"lindowan","LINDOWAN","ground/ghost",[125,95,112,70,95,55],45,238,"slow","cold_storage,back_from_the_brink",null,"bog","rare","high","od_ghost",
  ...
  SP(54,"cuprabug","CUPRABUG","bug/rock",[50,55,60,35,40,40],180,58,"fast","stonemason",[L("verdigrit",26)],"cave","common","low","od_rock",
  ...
  SP(55,"verdigrit","VERDIGRIT","bug/rock",[75,90,100,50,60,50],90,170,"medium","stonemason",null,"cave","uncommon","mid","od_rock",
  ...
  SP(56,"squeakwing","SQUEAKWING","poison/flying",[45,50,40,45,40,65],180,58,"fast","scavenger",[L("shriekwing",22)],"cave","common","low","od_flying",
  ...
  SP(57,"shriekwing","SHRIEKWING","poison/flying",[65,75,60,70,60,90],90,166,"medium","scavenger",null,"cave","uncommon","mid","od_poison",
  ...
  SP(58,"gloamite","GLOAMITE","ghost/rock",[50,45,70,50,55,35],150,62,"medium","iron_will",[LOC("gloamguard","alderley_edge_caverns_b3")],"cave","uncommon","low","od_rock",
  ...
  SP(59,"gloamguard","GLOAMGUARD","ghost/rock",[119,100,130,70,101,40],45,240,"slow","iron_will,back_from_the_brink",null,"cave","rare","high","od_rock",
  ...
  SP(60,"owlume","OWLUME","flying/psychic",[45,40,40,60,50,55],150,62,"medium","nightshift",[L("strigyx",26)],"forest","uncommon","low","od_psychic",
  ...
  SP(61,"strigyx","STRIGYX","flying/psychic",[105,70,89,110,107,95],45,238,"slow","nightshift",null,"forest","rare","high","od_psychic",
  ...
  SP(62,"webshade","WEBSHADE","bug/ghost",[40,50,45,50,45,55],180,58,"fast","silk_weave",[L("widowisp",27)],"mill","common","low","od_bug",
  ...
  SP(63,"widowisp","WIDOWISP","bug/ghost",[93,85,83,95,95,85],60,228,"slow","silk_weave",null,"mill","uncommon","high","od_bug",
  ...
  SP(64,"merlynx","MERLYNX","psychic/ghost",[119,85,107,130,130,105],3,300,"medium","nightshift",null,"cave","legendary","legendary","knights_waking",
  ...
  // ---- 1d. Chapter 3 belt ----------------------------------------
  SP(65,"quillet","QUILLET","psychic",[45,35,45,65,55,50],170,64,"fast","honeypot",[L("scriptorix",28)],"town","common","low","od_psychic",
  ...
  SP(66,"scriptorix","SCRIPTORIX","psychic",[100,60,89,115,112,85],60,230,"slow","honeypot",null,"town","uncommon","high","od_psychic",
  ...
  SP(67,"perchip","PERCHIP","water",[50,50,50,45,45,50],180,58,"fast","wetlander",[L("piketide",22)],"mere","common","low","od_water",
  ...
  SP(68,"piketide","PIKETIDE","water",[70,90,65,65,60,70],90,168,"medium","wetlander",null,"mere","uncommon","mid","od_water",
  ...
  SP(69,"swanling","SWANLING","water/flying",[55,55,50,45,45,50],170,62,"fast","rain_caller",[L("swanguard",26)],"mere","common","low","od_flying",
  ...
  SP(70,"swanguard","SWANGUARD","water/flying",[112,100,95,70,95,70],60,226,"slow","iron_will",null,"mere","uncommon","high","od_flying",
  ...
  SP(71,"manorwraith","MANORWRAITH","ghost",[93,60,83,95,101,60],45,196,"slow","nightshift",null,"estate","rare","high","od_ghost",
  ...
  SP(72,"bellmere","BELLMERE","water/ghost",[75,60,80,90,90,45],45,190,"slow","loud_bell",null,"mere","rare","mid","od_ghost",
  ...
  SP(73,"prickpip","PRICKPIP","grass",[50,50,55,40,45,40],180,58,"fast","deep_roots",[L("bramblehog",20)],"heath","common","low","od_grass",
  ...
  SP(74,"bramblehog","BRAMBLEHOG","grass",[70,75,80,50,60,55],90,164,"medium","deep_roots",[IT("thornarch","billhook_charm")],"heath","uncommon","mid","od_grass",
  ...
  SP(75,"thornarch","THORNARCH","grass",[125,105,130,65,95,40],45,242,"slow","deep_roots",null,"heath","rare","high","od_grass",
  ...
  // ---- 1e. Chapter 4 belt ----------------------------------------
  SP(76,"poltergrid","POLTERGRID","cyber/ghost",[93,65,83,105,107,80],45,214,"slow","signal_jammer",null,"rail","rare","high","od_cyber",
  ...
  SP(77,"keystone","KEYSTONE","rock",[60,55,80,40,55,30],170,62,"fast","fail_safe",[L("viaductus",30)],"rail","common","low","od_rock",
  ...
  SP(78,"viaductus","VIADUCTUS","rock",[139,100,148,55,95,35],60,232,"slow","iron_will",null,"rail","uncommon","high","od_rock",
  ...
  SP(79,"dishlet","DISHLET","cyber/psychic",[50,40,50,70,60,55],150,66,"medium","signal_jammer",[LOC("parabolus","jodrell_bank")],"sky","uncommon","low","od_cyber",
  ...
  SP(80,"parabolus","PARABOLUS","cyber/psychic",[112,70,107,120,119,60],45,244,"slow","signal_jammer",null,"sky","rare","high","od_cyber",
  ...
  SP(81,"pulsaris","PULSARIS","electric/psychic",[93,60,77,115,107,95],45,220,"slow","signal_jammer",null,"sky","rare","high","od_electric",
  ...
  SP(82,"cubbin","CUBBIN","normal/ground",[65,60,55,40,50,45],150,68,"medium","thick_fleece",[L("bruinhall",28)],"town","uncommon","low","od_ground",
  ...
  SP(83,"bruinhall","BRUINHALL","normal/ground",[146,115,112,55,89,50],45,246,"slow","iron_will",null,"town","rare","high","bruin_maul",
  ...
  SP(84,"runestane","RUNESTANE","rock/psychic",[65,60,75,60,60,35],150,70,"medium","stonemason",[L("dolmenor",30)],"moor","uncommon","low","od_rock",
  ...
  SP(85,"dolmenor","DOLMENOR","rock/psychic",[125,85,142,95,112,30],45,242,"slow","iron_will",null,"moor","rare","high","od_rock",
  ...
  SP(86,"mowstane","MOWSTANE","rock/ground",[132,110,137,50,83,40],45,240,"slow","iron_will",null,"moor","rare","high","od_rock",
  ...
  SP(87,"tudorling","TUDORLING","ghost/grass",[55,50,60,65,60,45],150,68,"medium","nightshift",[L("timberwraith",32)],"estate","uncommon","low","od_ghost",
  ...
  SP(88,"timberwraith","TIMBERWRAITH","ghost/grass",[132,95,125,80,101,35],45,244,"slow","nightshift",null,"estate","rare","high","od_ghost",
  ...
  SP(89,"otterkin","OTTERKIN","water",[55,55,50,45,50,60],170,64,"fast","wetlander",[L("lutrarch",28)],"river","common","low","od_water",
  ...
  SP(90,"lutrarch","LUTRARCH","water/ground",[119,100,101,70,95,80],60,234,"slow","wetlander",null,"river","uncommon","high","od_water",
  ...
  SP(91,"rottling","ROTTLING","grass/poison",[55,60,50,55,45,50],150,70,"medium","sandbox",[L("mulchmaw",26)],"orchard","uncommon","low","od_poison",
  ...
  SP(92,"mulchmaw","MULCHMAW","grass/poison",[85,85,80,75,70,50],90,178,"medium","sandbox",null,"orchard","uncommon","mid","od_poison",
  ...
  // ---- 1f. Chapter 5 belt ----------------------------------------
  SP(93,"belfrit","BELFRIT","normal",[55,50,60,60,60,45],170,70,"fast","loud_bell",[L("crossbell",30)],"town","common","low","od_normal",
  ...
  SP(94,"crossbell","CROSSBELL","rock/normal",[125,95,130,75,101,40],60,236,"slow","loud_bell",null,"roman","uncommon","high","od_normal",
  ...
  SP(95,"chuglet","CHUGLET","fire",[55,60,55,50,45,55],170,68,"fast","firebox",[L("shunterra",24)],"rail","common","low","od_fire",
  ...
  SP(96,"shunterra","SHUNTERRA","fire/ground",[80,90,80,60,65,60],90,176,"medium","firebox",[L("steamloco",40)],"rail","uncommon","mid","od_fire",
  ...
  SP(97,"steamloco","STEAMLOCO","fire/ground",[123,115,112,90,95,85],45,250,"slow","firebox",null,"rail","rare","high","od_fire",
  ...
  SP(98,"sparkrail","SPARKRAIL","electric",[50,55,45,70,50,80],170,70,"fast","static_charge",[L("pantogriff",30)],"rail","common","low","od_electric",
  ...
  SP(99,"pantogriff","PANTOGRIFF","electric/flying",[105,90,83,95,89,100],60,238,"slow","static_charge",null,"rail","uncommon","high","od_electric",
  ...
  SP(100,"sleeperk","SLEEPERK","ground/grass",[95,75,95,55,80,25],150,150,"medium","cold_storage",null,"rail","uncommon","mid","od_ground",
  ...
  SP(101,"bricklum","BRICKLUM","rock/ground",[125,100,137,45,83,35],60,232,"slow","fail_safe",null,"rail","uncommon","high","od_rock",
  ...
  SP(102,"curdli","CURDLI","normal",[60,45,55,45,55,35],180,64,"fast","thick_fleece",[L("cheshwheel",26)],"town","common","low","od_normal",
  ...
  SP(103,"cheshwheel","CHESHWHEEL","normal/ground",[139,95,125,50,95,60],60,230,"slow","thick_fleece",null,"town","uncommon","high","od_normal",
  ...
  // ---- 1g. Chapter 6 belt ----------------------------------------
  SP(104,"saltling","SALTLING","rock",[55,55,70,40,50,35],170,68,"fast","salt_crust",[L("cryssal",22)],"salt","common","low","od_rock",
  ...
  SP(105,"cryssal","CRYSSAL","rock",[75,80,100,55,70,45],90,180,"medium","salt_crust",[L("salberg",38)],"salt","uncommon","mid","od_rock",
  ...
  SP(106,"salberg","SALBERG","rock/water",[146,100,142,75,107,30],45,248,"slow","salt_crust",null,"salt","rare","high","od_rock",
  ...
  SP(107,"brinelet","BRINELET","water",[55,45,50,65,60,50],170,70,"fast","brine_body",[L("saltmaid",30)],"brine","common","low","od_water",
  ...
  SP(108,"saltmaid","SALTMAID","water/psychic",[112,70,95,115,119,60],60,240,"slow","brine_body,rain_caller",null,"brine","uncommon","high","od_water",
  ...
  SP(109,"crabbex","CRABBEX","water/rock",[60,65,75,35,50,45],170,70,"fast","salt_crust",[LOC("krabbaron","anderton")],"river","common","low","od_water",
  ...
  SP(110,"krabbaron","KRABBARON","water/rock",[125,110,130,55,95,45],60,240,"slow","salt_crust",null,"canal","uncommon","high","od_water",
  ...
  SP(111,"volteel","VOLTEEL","electric/water",[105,85,77,105,83,90],90,236,"slow","static_charge",null,"river","uncommon","high","od_electric",
  ...
  SP(112,"perrypip","PERRYPIP","grass",[55,50,55,60,55,45],170,68,"fast","deep_roots",[LOC("perryarch","y_berllan")],"orchard","common","low","od_grass",
  ...
  SP(113,"perryarch","PERRYARCH","grass/ground",[132,100,125,80,107,40],60,244,"slow","deep_roots",null,"orchard","uncommon","high","od_grass",
  ...
  SP(114,"brithyll","BRITHYLL","water",[75,70,70,85,85,75],45,192,"slow","wetlander",null,"orchard","rare","mid","od_water",
  ...
  SP(115,"ceffylwen","CEFFYLWEN","normal/psychic",[115,80,95,110,125,95],45,248,"slow","iron_will",null,"orchard","rare","high","od_psychic",
  ...
  SP(116,"derwydd","DERWYDD","grass/psychic",[125,80,112,110,125,45],45,246,"slow","deep_roots",null,"orchard","rare","high","od_grass",
  ...
  SP(117,"panscald","PANSCALD","fire/water",[80,80,75,90,80,60],90,182,"medium","sun_trap",null,"salt","uncommon","mid","od_fire",
  ...
  // ---- 1h. Chapter 7 belt ----------------------------------------
  SP(118,"terrataur","TERRATAUR","rock/ground",[171,130,148,70,112,45],3,320,"medium","iron_will",null,"salt","legendary","legendary","salt_cathedral",
  ...
  SP(119,"pillarnaut","PILLARNAUT","rock/ground",[100,90,120,50,80,30],90,186,"medium","salt_crust",null,"salt","uncommon","mid","od_rock",
  ...
  SP(120,"bargemog","BARGEMOG","normal/water",[90,80,80,60,80,55],120,178,"medium","wetlander",null,"canal","uncommon","mid","od_normal",
  ...
  SP(121,"ladymere","LADYMERE","ghost/psychic",[112,65,101,120,125,70],45,244,"slow","nightshift",null,"mere","rare","high","od_ghost",
  ...
  SP(122,"flashfin","FLASHFIN","water/rock",[65,70,70,45,55,55],170,72,"fast","salt_crust",[L("subsidon",34)],"salt","uncommon","low","od_water",
  ...
  SP(123,"subsidon","SUBSIDON","water/ground",[146,105,112,80,101,45],45,246,"slow","salt_crust",null,"salt","rare","high","od_ground",
  ...
  SP(124,"chordle","CHORDLE","cyber/normal",[70,60,65,90,80,85],45,190,"slow","loud_bell",null,"town","rare","mid","od_cyber",
  ...
  SP(125,"bitmite","BITMITE","cyber",[50,55,50,55,50,60],170,74,"fast","cold_storage",[L("teramite",34)],"cyber","common","low","od_cyber",
  ...
  SP(126,"teramite","TERAMITE","cyber",[121,105,107,105,107,75],45,250,"slow","cold_storage",null,"cyber","rare","high","od_cyber",
  ...
  SP(127,"virling","VIRLING","cyber/poison",[50,55,45,60,45,65],170,74,"fast","rootkit",[L("wormhack",25)],"cyber","common","low","od_cyber",
  ...
  SP(128,"wormhack","WORMHACK","cyber/poison",[112,100,95,95,95,90],60,240,"slow","rootkit",null,"cyber","uncommon","high","od_cyber",
  ...
  SP(129,"phishfin","PHISHFIN","cyber/water",[60,60,55,60,60,65],150,76,"medium","honeypot",[L("spearphish",28)],"mere","uncommon","low","od_cyber",
  ...
  SP(130,"spearphish","SPEARPHISH","cyber/water",[112,105,89,90,89,95],60,242,"slow","honeypot",null,"mere","uncommon","high","od_cyber",
  ...
  SP(131,"trojanox","TROJANOX","cyber/ground",[139,115,119,70,101,50],45,248,"slow","payload,rootkit",null,"cyber","rare","high","od_cyber",
  ...
  // ---- 1i. Chapter 8 belt ----------------------------------------
  SP(132,"zephyrion","ZEPHYRION","electric/flying",[139,105,107,125,119,115],3,330,"medium","ridge_wind",null,"sky","legendary","legendary","ridge_storm",
  ...
  SP(133,"mossling","MOSSLING","grass",[60,60,60,50,55,45],170,72,"fast","deep_roots",[L("mossbear",26)],"forest","common","low","od_grass",
  ...
  SP(134,"mossbear","MOSSBEAR","grass/ground",[139,105,119,70,101,45],60,242,"slow","deep_roots",null,"forest","uncommon","high","od_grass",
  ...
  SP(135,"oakling","OAKLING","grass",[55,55,60,50,55,40],170,70,"fast","deep_roots",[L("groveguard",25)],"forest","common","low","od_grass",
  ...
  SP(136,"groveguard","GROVEGUARD","grass",[90,90,95,70,80,45],90,190,"medium","deep_roots",null,"forest","uncommon","mid","od_grass",
  ...
  SP(137,"drownwood","DROWNWOOD","grass/ghost",[119,95,101,95,101,55],45,244,"slow","deep_roots",null,"forest","rare","high","od_ghost",
  ...
  SP(138,"lampyr","LAMPYR","bug/electric",[60,55,55,90,70,80],120,180,"medium","static_charge",null,"forest","uncommon","mid","od_bug",
  ...
  SP(139,"hornhound","HORNHOUND","normal",[85,100,75,50,70,90],120,186,"medium","scavenger",null,"heath","uncommon","mid","od_normal",
  ...
  SP(140,"falconet","FALCONET","flying",[55,65,50,50,50,80],170,74,"fast","ridge_wind",[L("peregrint",30)],"sandstone","common","low","od_flying",
  ...
  SP(141,"peregrint","PEREGRINT","flying",[112,110,89,70,89,125],60,244,"slow","ridge_wind",null,"sandstone","uncommon","high","od_flying",
  ...
  SP(142,"gargoylet","GARGOYLET","rock/flying",[60,60,80,50,60,50],150,78,"medium","stonemason",[L("grotesquire",34)],"sandstone","uncommon","low","od_rock",
  ...
  SP(143,"grotesquire","GROTESQUIRE","rock/flying",[132,110,142,70,101,60],45,250,"slow","stonemason",null,"sandstone","rare","high","od_rock",
  ...
  // ---- 1j. Chapter 9 belt ----------------------------------------
  SP(144,"egrette","EGRETTE","flying/water",[75,70,65,85,80,90],120,182,"medium","rain_caller",null,"marsh","common","mid","od_flying",
  ...
  SP(145,"curlewind","CURLEWIND","flying",[80,75,70,90,85,95],120,188,"medium","ridge_wind",null,"marsh","uncommon","mid","od_flying",
  ...
  SP(146,"turbinix","TURBINIX","electric/flying",[121,90,107,110,107,85],60,240,"slow","ridge_wind",null,"marsh","uncommon","high","od_electric",
  ...
  SP(147,"beaconflare","BEACONFLARE","fire/flying",[99,105,95,115,101,105],45,250,"slow","sun_trap",null,"sandstone","rare","high","od_fire",
  ...
  SP(148,"smogling","SMOGLING","poison",[60,50,55,70,60,55],170,76,"fast","sandbox",[L("chlorodon",30)],"chem","common","low","od_poison",
  ...
  SP(149,"chlorodon","CHLORODON","poison",[132,95,107,115,112,55],45,246,"slow","sandbox",null,"chem","uncommon","high","od_poison",
  ...
  SP(150,"proxling","PROXLING","poison/cyber",[55,55,50,65,50,70],150,78,"fast","proxy_fog",null,"fog","common","low","od_poison",
  ...
  SP(151,"sludgeon","SLUDGEON","water/poison",[152,100,107,90,107,45],45,246,"slow","sandbox",null,"river","rare","high","od_poison",
  ...
  SP(152,"grinkit","GRINKIT","normal",[55,55,50,60,60,80],120,84,"medium","slipstream",[FR("grinmalkin",200,"night")],"town","uncommon","low","grin_remains",
  ...
  SP(153,"grinmalkin","GRINMALKIN","normal/psychic",[92,90,89,125,114,110],45,252,"slow","cheshire_grin",null,"town","rare","high","grin_remains",
  ...
  SP(154,"mirrorling","MIRRORLING","psychic/ghost",[105,70,95,115,119,80],45,244,"slow","kernel_panic",null,"town","rare","high","od_psychic",
  ...
  SP(155,"quarkling","QUARKLING","cyber/electric",[55,55,50,65,60,75],150,80,"medium","overclock",[L("hadronaut",36)],"cyber","uncommon","low","od_cyber",
  ...
  SP(156,"hadronaut","HADRONAUT","cyber/electric",[99,110,109,105,102,95],45,252,"slow","overclock",null,"cyber","rare","high","od_cyber",
  ...
  SP(157,"firewaul","FIREWAUL","cyber/fire",[93,115,104,120,103,85],45,254,"slow","overclock",null,"cyber","rare","high","od_cyber",
  ...
  SP(158,"droneling","DRONELING","cyber/flying",[55,55,50,65,50,85],150,80,"medium","payload",[L("datadrake",30)],"cyber","uncommon","low","od_cyber",
  ...
  SP(159,"datadrake","DATADRAKE","cyber/flying",[96,105,95,115,94,115],45,252,"slow","payload",null,"cyber","rare","high","od_cyber",
  ...
  SP(160,"amoslurk","AMOSLURK","cyber/ghost",[80,85,75,95,80,95],45,220,"slow","proxy_fog,rootkit",null,"fog","rare","mid","od_cyber",
  ...
  SP(161,"shardmind","SHARDMIND","cyber/psychic",[112,80,95,115,112,90],45,240,"slow","kernel_panic",null,"cyber","unique","high","od_cyber",
  ...
  SP(162,"oracle_core","ORACLE CORE","cyber/psychic",[110,92,97,121,104,76],3,340,"medium","kernel_panic",null,"cyber","unique","legendary","oracle_escalate",
  ...
  SP(163,"glitchra","GLITCHRA","cyber/ghost",[120,110,112,135,123,120],3,340,"medium","kernel_panic",null,"sky","legendary","legendary","static_scream",
  ...
  SP(164,"legionet","LEGIONET","ghost",[60,65,60,55,60,60],150,84,"medium","nightshift",[L("centurigeist",40)],"roman","common","low","od_ghost",
  ...
  SP(165,"centurigeist","CENTURIGEIST","ghost/rock",[132,105,125,80,107,55],45,250,"slow","iron_will",null,"roman","uncommon","high","od_ghost",
  ...
  SP(166,"salmoneer","SALMONEER","water",[109,110,95,95,101,110],45,250,"slow","wetlander",null,"river","rare","high","od_water",
  ...
  SP(167,"pengwyn","PENGWYN","water/flying",[85,80,80,85,85,75],90,196,"medium","wetlander",null,"zoo","rare","mid","od_water",
  ...
  SP(168,"girafflor","GIRAFFLOR","normal/grass",[105,90,85,80,90,70],90,198,"medium","deep_roots",null,"zoo","rare","mid","od_normal",
  ...
  SP(169,"pandember","PANDEMBER","fire",[85,90,80,95,85,90],90,196,"medium","sun_trap",null,"zoo","rare","mid","od_fire",
  ...
  SP(170,"flarestack","FLARESTACK","fire/poison",[116,105,112,110,107,70],60,244,"slow","sun_trap",null,"chem","uncommon","high","od_fire",
  ...
  SP(171,"ebbwraith","EBBWRAITH","ghost/water",[118,90,107,115,125,65],45,248,"slow","nightshift",null,"marsh","rare","high","od_ghost",
  ...
  SP(97,"steamloco_overfired","STEAMLOCO","fire/ground",[110,135,90,110,80,100],3,260,"slow","firebox",null,"rail","unique","high","od_fire",
  ...
  SP(163,"glitchra_static","GLITCHRA","cyber/ghost",[110,125,95,150,105,130],3,350,"medium","kernel_panic",null,"sky","unique","legendary","static_scream",
  ...
  SP(162,"oracle_core_p2","ORACLE CORE","cyber/psychic",[117,101,105,130,113,84],3,360,"medium","kernel_panic",null,"cyber","unique","legendary","oracle_escalate",
  ...
  SP(162,"oracle_core_p3","ORACLE CORE","cyber/psychic",[126,109,109,143,122,92],3,380,"medium","kernel_panic",null,"cyber","unique","legendary","oracle_escalate",
  ...
  SP(160,"understudy","UNDERSTUDY","cyber/ghost",[105,110,95,120,100,110],3,270,"slow","proxy_fog,rootkit",null,"fog","unique","high","understudy_mask",
  ...
  D.validators.push(function (err) {
    ...
    D.each("species", function (s, id) {
      ...
      if (!(s.num >= 1 && s.num <= 171)) err("species/" + id + ": dex number out of range " + s.num);
    ...
    if (D.dexCount !== 171) err("species: expected 171 dex entries, found " + D.dexCount);
    // dex numbering must be complete 1..171
    for (let n = 1; n <= 171; n++) if (!nums[n]) err("species: no dex entry for number " + n);
