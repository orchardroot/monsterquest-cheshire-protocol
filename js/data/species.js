...
(function () {
  ...
  SP(11,"bigboy","BIGBOY","normal",[110,85,90,55,80,40],3,150,"medium","back_from_the_brink",null,"town","unique","high","brink_roar",
  ...
  SP(19,"jacquarda","JACQUARDA","bug/psychic",[80,70,80,115,95,80],45,232,"slow","signal_jammer",null,"silk","rare","high","od_psychic",
  ...
  SP(34,"panoptix","PANOPTIX","cyber/psychic",[75,65,85,115,95,85],45,236,"slow","honeypot",null,"urban","rare","high","od_cyber",
  ...
  SP(48,"botnetle","BOTNETLE","cyber/bug",[80,100,95,75,80,70],60,224,"slow","payload",null,"cyber","uncommon","high","od_cyber",
  ...
  SP(52,"toadlore","TOADLORE","water/poison",[100,80,85,85,90,45],60,226,"slow","sandbox",null,"bog","uncommon","high","od_water",
  ...
  SP(54,"lindowan","LINDOWAN","ground/ghost",[95,95,95,70,80,55],45,238,"slow","cold_storage,back_from_the_brink",null,"bog","rare","high","od_ghost",
  ...
  SP(60,"gloamguard","GLOAMGUARD","ghost/rock",[90,100,110,70,85,40],45,240,"slow","iron_will,back_from_the_brink",null,"cave","rare","high","od_rock",
  ...
  SP(62,"strigyx","STRIGYX","flying/psychic",[80,70,75,110,90,95],45,238,"slow","nightshift",null,"forest","rare","high","od_psychic",
  ...
  SP(64,"widowisp","WIDOWISP","bug/ghost",[70,85,70,95,80,85],60,228,"slow","silk_weave",null,"mill","uncommon","high","od_bug",
  ...
  SP(65,"merlynx","MERLYNX","psychic/ghost",[90,85,90,130,110,105],3,300,"medium","nightshift",null,"cave","legendary","legendary","knights_waking",
  ...
  SP(67,"scriptorix","SCRIPTORIX","psychic",[75,60,75,115,95,85],60,230,"slow","honeypot",null,"town","uncommon","high","od_psychic",
  ...
  SP(71,"swanguard","SWANGUARD","water/flying",[85,100,80,70,80,70],60,226,"slow","iron_will",null,"mere","uncommon","high","od_flying",
  ...
  SP(72,"manorwraith","MANORWRAITH","ghost",[70,60,70,95,85,60],45,196,"slow","nightshift",null,"estate","rare","high","od_ghost",
  ...
  SP(76,"thornarch","THORNARCH","grass",[95,105,110,65,80,40],45,242,"slow","deep_roots",null,"heath","rare","high","od_grass",
  ...
  // ---- 1e. Chapter 4 belt ----------------------------------------
  SP(77,"poltergrid","POLTERGRID","cyber/ghost",[70,65,70,105,90,80],45,214,"slow","signal_jammer",null,"rail","rare","high","od_cyber",
  ...
  SP(79,"viaductus","VIADUCTUS","rock",[105,100,125,55,80,35],60,232,"slow","iron_will",null,"rail","uncommon","high","od_rock",
  ...
  SP(81,"parabolus","PARABOLUS","cyber/psychic",[85,70,90,120,100,60],45,244,"slow","signal_jammer",null,"sky","rare","high","od_cyber",
  ...
  SP(82,"pulsaris","PULSARIS","electric/psychic",[70,60,65,115,90,95],45,220,"slow","signal_jammer",null,"sky","rare","high","od_electric",
  ...
  SP(87,"mowstane","MOWSTANE","rock/ground",[100,110,115,50,70,40],45,240,"slow","iron_will",null,"moor","rare","high","od_rock",
  ...
  SP(89,"timberwraith","TIMBERWRAITH","ghost/grass",[100,95,105,80,85,35],45,244,"slow","nightshift",null,"estate","rare","high","od_ghost",
  ...
  SP(91,"lutrarch","LUTRARCH","water/ground",[90,100,85,70,80,80],60,234,"slow","wetlander",null,"river","uncommon","high","od_water",
  ...
  SP(95,"crossbell","CROSSBELL","rock/normal",[95,95,110,75,85,40],60,236,"slow","loud_bell",null,"roman","uncommon","high","od_normal",
  ...
  SP(98,"steamloco","STEAMLOCO","fire/ground",[100,115,95,90,80,85],45,250,"slow","firebox",null,"rail","rare","high","od_fire",
  ...
  SP(100,"pantogriff","PANTOGRIFF","electric/flying",[80,90,70,95,75,100],60,238,"slow","static_charge",null,"rail","uncommon","high","od_electric",
  ...
  SP(102,"bricklum","BRICKLUM","rock/ground",[95,100,115,45,70,35],60,232,"slow","fail_safe",null,"rail","uncommon","high","od_rock",
  ...
  SP(104,"cheshwheel","CHESHWHEEL","normal/ground",[105,95,105,50,80,60],60,230,"slow","thick_fleece",null,"town","uncommon","high","od_normal",
  ...
  SP(107,"salberg","SALBERG","rock/water",[110,100,120,75,90,30],45,248,"slow","salt_crust",null,"salt","rare","high","od_rock",
  ...
  SP(109,"saltmaid","SALTMAID","water/psychic",[85,70,80,115,100,60],60,240,"slow","brine_body,rain_caller",null,"brine","uncommon","high","od_water",
  ...
  SP(111,"krabbaron","KRABBARON","water/rock",[95,110,110,55,80,45],60,240,"slow","salt_crust",null,"canal","uncommon","high","od_water",
  ...
  SP(112,"volteel","VOLTEEL","electric/water",[80,85,65,105,70,90],90,236,"slow","static_charge",null,"river","uncommon","high","od_electric",
  ...
  SP(114,"perryarch","PERRYARCH","grass/ground",[100,100,105,80,90,40],60,244,"slow","deep_roots",null,"orchard","uncommon","high","od_grass",
  ...
  SP(116,"ceffylwen","CEFFYLWEN","normal/psychic",[90,80,80,110,105,95],45,248,"slow","iron_will",null,"orchard","rare","high","od_psychic",
  ...
  SP(117,"derwydd","DERWYDD","grass/psychic",[95,80,95,110,105,45],45,246,"slow","deep_roots",null,"orchard","rare","high","od_grass",
  ...
  // ---- 1h. Chapter 7 belt ----------------------------------------
  SP(119,"terrataur","TERRATAUR","rock/ground",[130,130,125,70,95,45],3,320,"medium","iron_will",null,"salt","legendary","legendary","salt_cathedral",
  ...
  SP(122,"ladymere","LADYMERE","ghost/psychic",[85,65,85,120,105,70],45,244,"slow","nightshift",null,"mere","rare","high","od_ghost",
  ...
  SP(124,"subsidon","SUBSIDON","water/ground",[110,105,95,80,85,45],45,246,"slow","salt_crust",null,"salt","rare","high","od_ground",
  ...
  SP(127,"teramite","TERAMITE","cyber",[95,105,90,105,90,75],45,250,"slow","cold_storage",null,"cyber","rare","high","od_cyber",
  ...
  SP(132,"trojanox","TROJANOX","cyber/ground",[105,115,100,70,85,50],45,248,"slow","payload,rootkit",null,"cyber","rare","high","od_cyber",
  ...
  // ---- 1i. Chapter 8 belt ----------------------------------------
  SP(133,"zephyrion","ZEPHYRION","electric/flying",[105,105,90,125,100,115],3,330,"medium","ridge_wind",null,"sky","legendary","legendary","ridge_storm",
  ...
  SP(135,"mossbear","MOSSBEAR","grass/ground",[105,105,100,70,85,45],60,242,"slow","deep_roots",null,"forest","uncommon","high","od_grass",
  ...
  SP(138,"drownwood","DROWNWOOD","grass/ghost",[90,95,85,95,85,55],45,244,"slow","deep_roots",null,"forest","rare","high","od_ghost",
  ...
  SP(142,"peregrint","PEREGRINT","flying",[85,110,75,70,75,125],60,244,"slow","ridge_wind",null,"sandstone","uncommon","high","od_flying",
  ...
  SP(144,"grotesquire","GROTESQUIRE","rock/flying",[100,110,120,70,85,60],45,250,"slow","stonemason",null,"sandstone","rare","high","od_rock",
  ...
  SP(147,"turbinix","TURBINIX","electric/flying",[95,90,90,110,90,85],60,240,"slow","ridge_wind",null,"marsh","uncommon","high","od_electric",
  ...
  SP(148,"beaconflare","BEACONFLARE","fire/flying",[90,105,80,115,85,105],45,250,"slow","sun_trap",null,"sandstone","rare","high","od_fire",
  ...
  SP(150,"chlorodon","CHLORODON","poison",[100,95,90,115,95,55],45,246,"slow","sandbox",null,"chem","uncommon","high","od_poison",
  ...
  SP(162,"shardmind","SHARDMIND","cyber/psychic",[85,80,80,115,95,90],45,240,"slow","kernel_panic",null,"cyber","unique","high","od_cyber",
  ...
  SP(163,"oracle_core","ORACLE CORE","cyber/psychic",[130,110,115,145,125,90],3,340,"medium","kernel_panic",null,"cyber","unique","legendary","oracle_escalate",
  ...
  SP(167,"salmoneer","SALMONEER","water",[95,110,80,95,85,110],45,250,"slow","wetlander",null,"river","rare","high","od_water",
  ...
  SP(171,"flarestack","FLARESTACK","fire/poison",[100,105,95,110,90,70],60,244,"slow","sun_trap",null,"chem","uncommon","high","od_fire",
  ...
  SP(172,"ebbwraith","EBBWRAITH","ghost/water",[100,90,90,115,105,65],45,248,"slow","nightshift",null,"marsh","rare","high","od_ghost",
  ...
  SP(163,"oracle_core_p2","ORACLE CORE","cyber/psychic",[140,120,125,155,135,100],3,360,"medium","kernel_panic",null,"cyber","unique","legendary","oracle_escalate",
  ...
  SP(163,"oracle_core_p3","ORACLE CORE","cyber/psychic",[150,130,130,170,145,110],3,380,"medium","kernel_panic",null,"cyber","unique","legendary","oracle_escalate",
