...
- **Ch.1:** `contract_signed`, `starter_chosen` (value: starter line id `silkin` | `brinewt` | `kindlin` — ROSTER §1a; the Silk Moth / Salt Newt / Mill Ember lines), `cats_joined`, `white_nancy_seen`, `vex_battle_1`, `agent_sleet`, `bigboy_sat_kerridge`
